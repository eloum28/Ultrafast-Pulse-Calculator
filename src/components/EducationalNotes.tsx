      ...
      {expanded && (
        <div className="p-6 border-t border-slate-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-cyan-500 mb-2 border-b border-slate-800 pb-1">Average Power</h4>
            ...
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-cyan-500 mb-2 border-b border-slate-800 pb-1">Pulse Energy</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-cyan-500 mb-2 border-b border-slate-800 pb-1">Peak Power</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-cyan-500 mb-2 border-b border-slate-800 pb-1">Chirped Pulse Amplification</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-cyan-500 mb-2 border-b border-slate-800 pb-1">Pulse Shape</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
            ...
            <div>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-cyan-500 mb-2 border-b border-slate-800 pb-1">Missing Information</h4>
              <p className="text-xs text-slate-400 leading-relaxed">
